...
void UWheeledVehicleMovementComponent4W::SetBrakeTorque(float BrakeTorque, int32 WheelIndex)
{
#if WITH_PHYSX_VEHICLES
	if (PVehicle && !bEngineDrive && UpdatedPrimitive)
	{
...
void UWheeledVehicleMovementComponent4W::SetDriveTorque(float DriveTorque, int32 WheelIndex)
{
#if WITH_PHYSX_VEHICLES
	if (PVehicle && !bEngineDrive && UpdatedPrimitive)
	{
