...
try:
    ...
    vehicle.apply_control(carla.VehicleControl(fl=5.0, fr=5.0, bl=5.0, br=5.0))  # 차 제어.
    ...
    vehicle2.apply_control(carla.VehicleControl(fl=5.0, fr=5.0, bl=5.0, br=5.0))  # 차 제어.
